...
// })
/// connection start
mongoose.connect('mongodb+srv://gowthamvarri:c8tFHI8Pr87uo20S@mymangodb.dj6thnd.mongodb.net/MYMANGODB?retryWrites=true&w=majority')
  .then(() =>
...
const savedOTPS = {};
app.post('/reqotp', async(req,res,next)=>{
